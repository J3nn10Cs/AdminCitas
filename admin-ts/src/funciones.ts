//Importaciones
import { fechaImput,inputPaciente, inputPropietario, inputSintomas , inputEmail, submitForm, formulario} from "./selectores"
import { citaObj,editando } from "./variables"
import AdminCitas from "./Class/AdminCitas"
import Notificacion from "./Class/Notificaciones"
...
export const cargarEdicion = (cita : Cita) => {
...
export function createDataBase(){
    ...
    //Definir el schema
    createDb.onupgradeneeded = function(e : IDBVersionChangeEvent){
